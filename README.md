...
I'm a 4th-year Electrical Engineering student passionate about Software development. I love all things coding, and I am most experienced with Python, C++, and React.

## Website:

For more information about who I am, my experience, and my past projects, feel free to check out my website: www.erictannant.com

## Projects:

- [Crystal](https://github.com/EricTannant/crystal): Locally run AI Agents that act as personal assistants and help manage your day-to-day life. Written in Python using ollama for local LLM with API support for other LLMs.
- Local-API-Mock-Server: Tool for simulating and validating front-end REST API functionality before a complete back-end is implemented. Written in Python using FastAPI
- Portfolio Website: Personal Portfolio Website made using React, written in JavaScript.
- [Drone Data Parser](https://github.com/EricTannant/drone-data-parser): Python scripts for processing and analyzing DJI drone and 3D survey data
...
- LinkedIn: www.linkedin.com/in/eric-tannant/
- Website: www.erictannant.com
